...
require_once('ulogin/config/pdo.inc.php');
...
class ulLoginBackend
{
	...
	//Create the MYSQL Session
		$db = new PDO(UL_PDO_CON_STRING, UL_PDO_UPDATE_USER, UL_PDO_UPDATE_PWD);
	}
	...
	{
		$stmt = $db->prepare("INSERT INTO ul_users (username, password) VALUES (:name, :password");
		$stmt->bindParam(':name', $username);

		//Hash the password and bind the param
